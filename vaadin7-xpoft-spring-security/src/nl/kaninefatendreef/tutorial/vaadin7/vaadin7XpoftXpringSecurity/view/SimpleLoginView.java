...
@VaadinView(SimpleLoginView.NAME)
...
implements View,
    ...
    public SimpleLoginView(EventBus eventBus) {
    	...
    	_eventBus = eventBus;
          ...
          _user.setInputPrompt("Your username (eg. user:password)");
          ...
          fields.setCaption("Please login to access the application. (user/password)");
